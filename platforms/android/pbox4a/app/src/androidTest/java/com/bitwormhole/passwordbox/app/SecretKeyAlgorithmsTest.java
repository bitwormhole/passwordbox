...
import com.bitwormhole.passwordbox.app.core.keybase.SecretKeyAlgorithmSelector;
...
public class SecretKeyAlgorithmsTest {

    @Test
    public void testSecretKeyWithAKS() {
        this.playForSecretKey("AndroidKeyStore");
    }

    @Test
    public void testSecretKeyWithNull() {
        this.playForSecretKey(null);
    }

    @Test
    public void testSecretKeyWithBC() {
        this.playForSecretKey("BC");
    }

    @Test
    public void testSecretKeyWithAoSSL() {
        this.playForSecretKey("AndroidOpenSSL");
    }


    /// ////////////////////////////////////////////////////////////////////////////////////////////

    public void playForSecretKey(String provider0) {

        String provider1 = null;
        final String tag = "testAndroidCipherAlgorithms";
        AlgorithmsChecker checker = new AlgorithmsChecker();
        List<SecretKeyAlgorithmSelector> results = checker.checkSecretKeyAlgorithms(provider0);
        StringBuilder msg = new StringBuilder();

        List<String> listOK = new ArrayList<>();
        List<String> listErr = new ArrayList<>();

        for (SecretKeyAlgorithmSelector sel : results) {

            provider1 = sel.getProvider();

            msg.setLength(0);
            msg.append("[check algorithm_type:secret-key");
